...
const debug = (0, debug_1.default)('evergreen:benny:message');
class Benny {
    constructor() {
    ...
    exec(args, input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cmd = (0, child_process_1.spawn)(this.binPath, args);
            this.childProcesses.push(cmd);
            Benny.handleInput(input, cmd);
    ...
    static handleInput(input, command) {
        var _a;
        if (!input)
            return;
