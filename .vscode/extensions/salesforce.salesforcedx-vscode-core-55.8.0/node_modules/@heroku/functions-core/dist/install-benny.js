...
function parseVersion() {
    let output = (0, child_process_1.execSync)(`${benny.localPath} -version`, {
...
function verifyGPG(msgPath, keyPath, sigPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const messageString = fs.readFileSync(msgPath, 'utf8');
        ...
        const message = yield openpgp.createMessage({ text: messageString });
        ...
        try {
            yield verified; // throws on invalid signature
        }
        catch (err) {
            throw new Error('Invalid latest file signature\n' + err.message);
        }
    });
}
