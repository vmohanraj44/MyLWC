...
exports.LocalRunProcess = exports.LocalRun = exports.Benny = exports.getFunctionsBinary = exports.runFunction = exports.getProjectDescriptor = exports.FunctionsError = exports.generateFunction = exports.generateProject = void 0;
...
var local_run_1 = require("./local-run");
Object.defineProperty(exports, "LocalRun", { enumerable: true, get: function () { return local_run_1.LocalRun; } });
var local_run_process_1 = require("./local-run-process");
Object.defineProperty(exports, "LocalRunProcess", { enumerable: true, get: function () { return local_run_process_1.LocalRunProcess; } });
...
module.exports = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, require('./generate/project')), require('./generate/function')), require('./util/functions-error')), require('./util/project-descriptor')), require('./run/function')), require('./run/functions-binary')), require('./benny')), require('./local-run')), require('./local-run-process'));
