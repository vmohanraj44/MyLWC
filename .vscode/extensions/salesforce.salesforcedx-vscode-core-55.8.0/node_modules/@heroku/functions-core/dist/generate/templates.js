...
class Template {
    write(tplConfig) {
        ...
        (0, fs_extra_1.mkdirpSync)(tplConfig.fnDir);
    ...
    writeFileFromTemplate(writeTemplate) {
        const tplFileContents = (0, fs_extra_1.readFileSync)(writeTemplate.tplFile, 'utf8');
        ...
        (0, fs_extra_1.outputFileSync)(file, fileContents);
    }
}
/**
 * Manages templates.
...
class Javascript extends Template {
    ...
    writeLanguageFiles(tplConfig) {
        ...
        (0, fs_extra_1.mkdirpSync)(fnTestDir);
        this.writeFileFromTemplate({
            fnDir: fnTestDir,
...
class Java extends Template {
    ...
    copyRecursivelySync(dir, targetDir) {
        (0, fs_extra_1.readdirSync)(dir).forEach((entry) => {
            const fullEntryPath = path.join(dir, entry);
            if ((0, fs_extra_1.lstatSync)(fullEntryPath).isDirectory()) {
                (0, fs_extra_1.mkdirpSync)(fullEntryPath);
                ...
                if (path.extname(entry) === '.tpl') {
                    ...
                    this.writeFileFromTemplate({
                        fnDir: targetDir,
                        toFile: filenameTemplate({ fnName: this.fnNameJavaClass }),
                ...
                (0, fs_extra_1.copySync)(fullEntryPath, path.join(targetDir, entry));
            }
        });
    }
}
