...
function registerCommands() {
    ...
    const launchFromLogFilePathCmd = vscode.commands.registerCommand('sfdx.launch.replay.debugger.logfile.path', logFilePath => {
        if (logFilePath) {
            launchFromLogFile_1.launchFromLogFile(logFilePath, true);
        }
    });
    ...
    return vscode.Disposable.from(promptForLogCmd, launchFromLogFileCmd, launchFromLogFilePathCmd, launchFromLastLogFileCmd, sfdxCreateCheckpointsCmd, sfdxToggleCheckpointCmd);
}
