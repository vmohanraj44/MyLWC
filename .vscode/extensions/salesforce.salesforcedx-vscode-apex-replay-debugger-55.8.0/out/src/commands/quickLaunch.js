...
class QuickLaunch {
    debugTest(testClass, testName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const testResult = yield this.runTests(connection, testClass, testName);
            if (testResult.success && testResult.logFileId) {
                const logFileRetrieve = yield this.retrieveLogFile(connection, testResult.logFileId);
                if (logFileRetrieve.success && logFileRetrieve.filePath) {
                    launchFromLogFile_1.launchFromLogFile(logFileRetrieve.filePath, false);
                    return true;
                }
            }
    ...
    runTests(connection, testClass, testMethod) {
        return __awaiter(this, void 0, void 0, function* () {
